...
parser.add_argument("--ldgp_path", type=str, default="./dataset/Rain100L/ldgp/", help='input path')
parser.add_argument("--save_path", type=str, default="./dataset/Rain100L/sdr/" , help='sdr save path')
parser.add_argument("--fuse_save_path", type=str, default="./dataset/Rain100L/sdr(fuse)/" , help='fuse sdr save path')
