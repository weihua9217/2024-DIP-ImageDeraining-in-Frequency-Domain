...
parser.add_argument("--rainy_data_path", type=str, default="./dataset/Rain100L/input/", help='Path to rainy data')
parser.add_argument("--ldgp_data_path", type=str, default="./dataset/Rain100L/ldgp_mul/", help='Path to ldgp data')
parser.add_argument("--sdr_result_path", type=str, default="./dataset/Rain100L/sdr_mul/", help='Path to save sdr data')
parser.add_argument("--gt_path", type=str, default="./dataset/Rain100L/target/", help='Path to save sdr data')
