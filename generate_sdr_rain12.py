...
parser.add_argument("--rainy_data_path", type=str, default="./dataset/Rain12/input/", help='Path to rainy data')
parser.add_argument("--ldgp_data_path", type=str, default="./dataset/Rain12/ldgp_mul/", help='Path to ldgp data')
parser.add_argument("--sdr_result_path", type=str, default="./dataset/Rain12/sdr_mul/", help='Path to save sdr data')
parser.add_argument("--gt_path", type=str, default="./dataset/Rain12/target/", help='Path to save sdr data')
